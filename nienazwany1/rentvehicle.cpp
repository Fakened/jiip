...
rentVehicle::rentVehicle(QWidget *parent):
    QMainWindow(parent),
    ui(new Ui::rentVehicle)
    {
        ui->setupUi(this);
...
void rentVehicle::on_pushButton_clicked()
{
    try
    {
...
void rentVehicle::on_pushButton_2_clicked()
{
    int id;
    string name;
    id = ui->spinBox->value();
    ...
    if (id == 0 || name == "")
    {
        QMessageBox::information(this, "Error", "Ivalid data");
    }
    else
    {
        bool found = false;
